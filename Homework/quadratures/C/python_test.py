...
res2, err2, infodict2 = integrate.quad(f2, 0, np.inf, epsabs=0.001, epsrel=0.001, full_output=True)
...
print("(sin(x)/x)^2 - Python implementation: " + str(res2) + ". It took " + str(infodict2['neval']) + " iterations.")
