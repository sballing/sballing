...
public class main{
	...
	public static void Main(){
		...
		WriteLine($"Int sqrt(x) from 0 to 1: {res1}");
		WriteLine($"Int 1/sqrt(x) from 0 to 1: {res2}");
		WriteLine($"Int 4*sqrt(1-x^2) from 0 to 1: {res3}");
		WriteLine($"Int log(x)/sqrt(x) from 0 to 1: {res4}");
		WriteLine("\n------------------------------------");
